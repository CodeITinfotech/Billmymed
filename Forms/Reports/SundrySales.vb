...
Public Class SundrySales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.SundrySales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSundrySales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SundrySales = New SundrySales()
        rpt.Site = Me.Site
        Return rpt
    End Function
