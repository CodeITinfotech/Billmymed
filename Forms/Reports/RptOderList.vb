...
Public Class RptOderList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptOderList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptOderList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptOderList = New RptOderList()
        rpt.Site = Me.Site
        Return rpt
    End Function
