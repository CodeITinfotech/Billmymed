...
Public Class RptPndDLNote
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptPndDLNote.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPndDLNote
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPndDLNote = New RptPndDLNote()
        rpt.Site = Me.Site
        Return rpt
    End Function
