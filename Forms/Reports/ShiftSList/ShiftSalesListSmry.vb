...
Public Class ShiftSalesListSmry
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.ShiftSalesListSmry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShiftSalesListSmry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShiftSalesListSmry = New ShiftSalesListSmry()
        rpt.Site = Me.Site
        Return rpt
    End Function
