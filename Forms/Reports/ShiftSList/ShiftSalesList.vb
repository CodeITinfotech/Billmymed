...
Public Class ShiftSalesList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.ShiftSalesList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShiftSalesList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShiftSalesList = New ShiftSalesList()
        rpt.Site = Me.Site
        Return rpt
    End Function
