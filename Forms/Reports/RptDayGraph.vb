...
Public Class RptDayGraph
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptDayGraph.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDayGraph
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDayGraph = New RptDayGraph()
        rpt.Site = Me.Site
        Return rpt
    End Function
