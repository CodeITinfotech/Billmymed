...
Public Class RptComSupList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptComSupList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptComSupList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptComSupList = New RptComSupList()
        rpt.Site = Me.Site
        Return rpt
    End Function
