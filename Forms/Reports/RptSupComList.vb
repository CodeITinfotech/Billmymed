...
Public Class RptSupComList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptSupComList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSupComList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSupComList = New RptSupComList()
        rpt.Site = Me.Site
        Return rpt
    End Function
