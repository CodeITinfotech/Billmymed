...
Public Class RptNonStockProd
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptNonStockProd.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptNonStockProd
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptNonStockProd = New RptNonStockProd()
        rpt.Site = Me.Site
        Return rpt
    End Function
