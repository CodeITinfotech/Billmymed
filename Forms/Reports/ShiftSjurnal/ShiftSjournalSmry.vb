...
Public Class ShiftSjournalSmry
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.ShiftSjournalSmry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShiftSjournalSmry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShiftSjournalSmry = New ShiftSjournalSmry()
        rpt.Site = Me.Site
        Return rpt
    End Function
