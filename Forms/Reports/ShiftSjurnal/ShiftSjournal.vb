...
Public Class ShiftSjournal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.ShiftSjournal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShiftSjournal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShiftSjournal = New ShiftSjournal()
        rpt.Site = Me.Site
        Return rpt
    End Function
