...
Public Class RptGraphSVOP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptGraphSVOP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptGraphSVOP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptGraphSVOP = New RptGraphSVOP()
        rpt.Site = Me.Site
        Return rpt
    End Function
