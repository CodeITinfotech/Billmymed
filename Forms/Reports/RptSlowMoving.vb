...
Public Class RptSlowMoving
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptSlowMoving.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSlowMoving
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSlowMoving = New RptSlowMoving()
        rpt.Site = Me.Site
        Return rpt
    End Function
