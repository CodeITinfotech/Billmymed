...
Public Class ExpiryForcastSmall
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.ExpiryForcastSmall.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExpiryForcastSmall
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExpiryForcastSmall = New ExpiryForcastSmall()
        rpt.Site = Me.Site
        Return rpt
    End Function
