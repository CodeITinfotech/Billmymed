...
Public Class RptLockedProducts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptLockedProducts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLockedProducts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLockedProducts = New RptLockedProducts()
        rpt.Site = Me.Site
        Return rpt
    End Function
