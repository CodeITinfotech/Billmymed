...
Public Class RptStockAndSale1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptStockAndSale1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptStockAndSale1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptStockAndSale1 = New RptStockAndSale1()
        rpt.Site = Me.Site
        Return rpt
    End Function
