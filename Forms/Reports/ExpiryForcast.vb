...
Public Class ExpiryForcast
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.ExpiryForcast.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExpiryForcast
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExpiryForcast = New ExpiryForcast()
        rpt.Site = Me.Site
        Return rpt
    End Function
