...
Public Class RptStockAdj
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptStockAdj.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptStockAdj
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptStockAdj = New RptStockAdj()
        rpt.Site = Me.Site
        Return rpt
    End Function
