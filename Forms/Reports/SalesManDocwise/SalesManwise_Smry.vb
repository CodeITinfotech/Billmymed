...
Public Class SalesManwise_Smry
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.SalesManwise_Smry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesManwise_Smry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesManwise_Smry = New SalesManwise_Smry()
        rpt.Site = Me.Site
        Return rpt
    End Function
