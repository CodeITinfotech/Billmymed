...
Public Class SalesManwise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.SalesManwise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesManwise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesManwise = New SalesManwise()
        rpt.Site = Me.Site
        Return rpt
    End Function
