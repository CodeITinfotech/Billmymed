...
Public Class CustwiseSmall
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.CustwiseSmall.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCustwiseSmall
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustwiseSmall = New CustwiseSmall()
        rpt.Site = Me.Site
        Return rpt
    End Function
