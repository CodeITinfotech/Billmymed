...
Public Class RptInvPayable
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptInvPayable.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptInvPayable
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptInvPayable = New RptInvPayable()
        rpt.Site = Me.Site
        Return rpt
    End Function
