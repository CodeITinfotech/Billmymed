...
Public Class RptBatchWiseStock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptBatchWiseStock.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBatchWiseStock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBatchWiseStock = New RptBatchWiseStock()
        rpt.Site = Me.Site
        Return rpt
    End Function
