...
Public Class Sjournal_YearSmry
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.Sjournal_YearSmry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSjournal_YearSmry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Sjournal_YearSmry = New Sjournal_YearSmry()
        rpt.Site = Me.Site
        Return rpt
    End Function
