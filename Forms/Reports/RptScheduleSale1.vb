...
Public Class RptScheduleSale1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptScheduleSale1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptScheduleSale1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptScheduleSale1 = New RptScheduleSale1()
        rpt.Site = Me.Site
        Return rpt
    End Function
