...
Public Class RptInvReceivable
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptInvReceivable.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptInvReceivable
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptInvReceivable = New RptInvReceivable()
        rpt.Site = Me.Site
        Return rpt
    End Function
