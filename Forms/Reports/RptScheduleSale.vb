...
Public Class RptScheduleSale
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Amruth_II_Pharma_Retail.RptScheduleSale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptScheduleSale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptScheduleSale = New RptScheduleSale()
        rpt.Site = Me.Site
        Return rpt
    End Function
