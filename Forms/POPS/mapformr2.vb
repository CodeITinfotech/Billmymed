...
errmsg:
    ...
    Public Sub Write_Product_Details()
        ...
        If mode = "E" Then
            cmd.Connection = Conn
            cmd.CommandText = "update product set prdname=""" & txtname.Text & _
                """,case1=""" & txtcase1.Text & """,unit1=" & txtunit1.Text & ",case2=""" & Trim(txtcase2.Text) & _
                """,unit2=" & Txtunit2.Text & ",case3=""" & Trim(Txtcase3.Text) & """,unit3=" & Txtunit3.Text & _
...
errmsg:
    ...
    Private Sub comok_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Comok.Click
        ...
        txtcode.Tag = tmpcode
        WCode = tmpcode
        If Not CheckPOPSConnection() Then
            MsgBox("Can't connect POPS Server...")
        ...
        scmd.Parameters.Add("@rpcode", SqlDbType.VarChar).Value = tmpcode
        scmd.Parameters.Add("@wpcode", SqlDbType.VarChar).Value = Frm.Tag
