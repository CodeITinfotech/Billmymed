...
Module clsColors
    ...
    'Public clrHorBG_GrayBlue As Color = Color.FromArgb(255, 255, 192, 128)
    'Public clrHorBG_White As Color = Color.FromArgb(255, 244, 247, 252)
    ''Public clrSubmenuBG As Color = Color.FromArgb(255, 240, 240, 240)
    'Public clrSubmenuBG As Color = Color.FromArgb(255, 255, 239, 213)
    ''Public clrImageMarginBlue As Color = Color.FromArgb(255, 212, 216, 230)
    ''Public clrImageMarginBlue As Color = Color.FromArgb(255, 244, 164, 96)
    'Public clrImageMarginBlue As Color = Color.FromArgb(255, 244, 164, 96)
    ...
    'Public clrSelectedBG_Blue As Color = Color.FromArgb(255, 244, 164, 96)
    ''Public clrSelectedBG_Header_Blue As Color = Color.FromArgb(255, 146, 202, 230)
    'Public clrSelectedBG_Header_Blue As Color = Color.FromArgb(255, 245, 222, 179)
    ...
    'Public clrSelectedBG_Drop_Blue As Color = Color.FromArgb(255, 245, 222, 179)
    ...
    Public clrHorBG_GrayBlue As Color = Color.FromArgb(245, 222, 179)
    Public clrHorBG_White As Color = Color.FromArgb(255, 244, 247, 252)
    Public clrSubmenuBG As Color = Color.FromArgb(255, 240, 240, 240)
    Public clrImageMarginBlue As Color = Color.FromArgb(245, 222, 179)
    Public clrImageMarginWhite As Color = Color.FromArgb(255, 244, 247, 252)
    Public clrImageMarginLine As Color = Color.FromArgb(255, 160, 160, 180)
    Public clrSelectedBG_Blue As Color = Color.FromArgb(244, 164, 96)
    Public clrSelectedBG_Header_Blue As Color = Color.FromArgb(245, 222, 179)
    Public clrSelectedBG_White As Color = Color.FromArgb(255, 241, 248, 251)
    Public clrSelectedBG_Border As Color = Color.FromArgb(255, 150, 217, 249)
    Public clrSelectedBG_Drop_Blue As Color = Color.FromArgb(245, 222, 179) '-----------------------205, 133, 63
    Public clrSelectedBG_Drop_Border As Color = Color.Red 'Color.FromArgb(255, 48, 127, 177)
    Public clrMenuBorder As Color = Color.Red ' Color.FromArgb(255, 160, 160, 160)
    Public clrCheckBG As Color = Color.FromArgb(245, 222, 179)

    Public clrVerBG_GrayBlue As Color = Color.FromArgb(245, 222, 179)
    Public clrVerBG_White As Color = Color.FromArgb(255, 250, 250, 253)
    Public clrVerBG_Shadow As Color = Color.FromArgb(255, 181, 190, 206)

    'Public clrToolstripBtnGrad_Blue As Color = Color.FromArgb(245, 222, 179)
    'Public clrToolstripBtnGrad_White As Color = Color.FromArgb(255, 237, 248, 253)
    'Public clrToolstripBtn_Border As Color = Color.FromArgb(255, 41, 153, 255)
    'Public clrToolstripBtnGrad_Blue_Pressed As Color = Color.FromArgb(0, 100, 0)
    'Public clrToolstripBtnGrad_White_Pressed As Color = Color.FromArgb(255, 228, 245, 252)
    Public clrToolstripBtnGrad_Blue As Color = Color.FromArgb(255, 140, 0)
    Public clrToolstripBtnGrad_White As Color = Color.FromArgb(255, 237, 248, 253)
    Public clrToolstripBtn_Border As Color = Color.Red 'Color.FromArgb(255, 41, 153, 255)
    Public clrToolstripBtnGrad_Blue_Pressed As Color = Color.FromArgb(255, 140, 0)
    Public clrToolstripBtnGrad_White_Pressed As Color = Color.FromArgb(255, 228, 245, 252)
    ...
    Public Class clsMenuRenderer
        ...
        Protected Overrides Sub InitializeItem(ByVal item As System.Windows.Forms.ToolStripItem)
            ...
            If item.Text.Contains("Reliable") Then
        ...
        Protected Overrides Sub OnRenderMenuItemBackground(ByVal e As System.Windows.Forms.ToolStripItemRenderEventArgs)
            ...
            If e.Item.Enabled Then
                If e.Item.IsOnDropDown = False AndAlso e.Item.Selected Then
                    ...
                    If e.Item.Text.Contains("Reliable") Then
                ...
                If CType(e.Item, ToolStripMenuItem).DropDown.Visible AndAlso e.Item.IsOnDropDown = False Then 'CType(e.Item, ToolStripMenuItem).OwnerItem Is Nothing Then
                    Dim rect As New Rectangle(3, 2, e.Item.Width - 6, e.Item.Height - 4)
                    Dim b As New Drawing2D.LinearGradientBrush(rect, Color.White, clrSelectedBG_Drop_Blue, Drawing2D.LinearGradientMode.Vertical) 'menustrip main one shade
                    ...
                    clsColors.DrawRoundedRectangle(e.Graphics, rect.Left - 2, rect.Top - 2, rect.Width + 2, rect.Height + 3, 4, Color.White) 'menustrip main border
                    ' e.Item.ForeColor = Color.Black 'main forecolor
                    If e.Item.Text.Contains("Reliable") Then
                        e.Item.ForeColor = Color.Maroon
                    Else
                        e.Item.ForeColor = Color.Black
    ...
    End Class
End Module
Public Class clsColorToolstripRenderer
